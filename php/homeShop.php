...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./../css/learningLanguage_shop.css">
    <link rel="stylesheet" type="text/css" href="./../css/learningLanguage_rank.css">
    <script type="text/javascript" src="./../js/ajax/ajaxManager.js"></script>
    <script type="text/javascript" src="./../js/ajax/ShopDataLoader.js"></script>
	...
	<?php
		echo '<body onload="AccountDataLoader.loadData(' . NAVBAR_USER_DATA . '); ShopDataLoader.updatePowerupData('. SHOP_BUTTON .'); AccountDataLoader.loadData('. RANK_DATA.')">';

		include DIR_LAYOUT . "menu.php";
	?>

	<script type="text/javascript">
		document.getElementById("shopTxt").setAttribute("class", "highlighted_text title");
		document.getElementById("shopImg").setAttribute("class", "menu_item_image shop_img_1");

		//active when bottom menu is visible
		document.getElementById("bottom_shopImg").setAttribute("class", "menu_item_image shop_img_1");
	</script>

	<?php
		echo '<div id="content">';
		
		include DIR_LAYOUT . "shop.php";
